...
HD_PWD='C:/data/FPGA/pingpong/pingpong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pingpong.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pingpong.tcl -notrace
